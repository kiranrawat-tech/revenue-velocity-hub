          ...
          >
            <div className="glass-card-hover">
              <CollapsibleTrigger className="flex w-full items-center justify-between p-4 text-left">
                ...
                <ChevronDown className={`h-4 w-4 text-muted-foreground transition-transform duration-200 ${openGroups[group.title] ? "rotate-180" : ""}`} />
              </CollapsibleTrigger>
                    ...
                    <div key={field.key} className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          max={field.max}
                          step={field.step || 1}
                          className={`bg-secondary/50 border-border/50 focus:border-primary/50 h-9 text-sm ${field.prefix ? "pl-7" : ""} ${field.suffix ? "pr-10" : ""}`}
                        />
                        {field.suffix && (
